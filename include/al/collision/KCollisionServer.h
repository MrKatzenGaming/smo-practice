...
public:
    KCollisionServer();
    void areaOffsetSpaceToObjectSpace(sead::Vector3f*, sead::Vector3u const&, al::KCPrismHeader const*) const;
    int calcAreaBlockOffset(sead::Vector3u const&, al::KCPrismHeader const*) const;
    static int calcChildBlockOffset(sead::Vector3u const&, int);
    ...
    void getAreaSpaceSize(sead::Vector3u*, al::KCPrismHeader const*) const;
    ...
    inline bool isInsideMinMaxInAreaOffsetSpace(sead::Vector3u const&, al::KCPrismHeader const*) const;
    ...
    // KCHit*
    void objectSpaceToAreaOffsetSpace(sead::Vector3u*, sead::Vector3f const&, al::KCPrismHeader const*) const;
    void objectSpaceToAreaOffsetSpaceV3f(sead::Vector3f*, sead::Vector3f const&, al::KCPrismHeader const*) const;
    bool outCheckAndCalcArea(sead::Vector3u*, sead::Vector3u*, sead::Vector3f const&, sead::Vector3f const&, al::KCPrismHeader const*) const;
    // search*
    void setData(void*);
