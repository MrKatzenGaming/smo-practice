...
template <typename T>
inline void Matrix33<T>::fromQuat(const QuatT& q)
{
...
template <typename T>
inline void Matrix33<T>::toQuat(QuatT& q) const
{
...
template <typename T>
inline void Matrix44<T>::fromQuat(const QuatT& q)
{
...
template <typename T>
inline void Matrix44<T>::toQuat(QuatT& q) const
{
